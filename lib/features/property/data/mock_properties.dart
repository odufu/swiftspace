...
List<Property> _generateMockData() {
  ...
  final List<Map<String, dynamic>> listers = [
    {'id': 'ag_1', 'name': 'Chief Okafor', 'phone': '+234 803 421 8876', 'type': ListerType.owner},
    {
      'id': 'ag_2',
      'name': 'Agent Tunji', 
    ...
    {'id': 'ag_3', 'name': 'Nnamdi Estates Ltd', 'phone': '+234 808 112 3344', 'type': ListerType.developer},
    {'id': 'ag_4', 'name': 'Alhaji Musa Realty', 'phone': '+234 705 993 0011', 'type': ListerType.agent},
    {'id': 'ag_5', 'name': 'Oluwaseun & Sons', 'phone': '+234 901 221 4490', 'type': ListerType.developer},
    {'id': 'ag_6', 'name': 'Caleb Homes Agency', 'phone': '+234 802 887 6543', 'type': ListerType.agent},
    {'id': 'ag_7', 'name': 'Amarachi Properties', 'phone': '+234 814 551 8293', 'type': ListerType.owner},
    {'id': 'ag_8', 'name': 'Engr. Tunde Fasola', 'phone': '+234 811 390 5631', 'type': ListerType.developer},
    {'id': 'ag_9', 'name': 'Mrs. Ngozi Dike', 'phone': '+234 907 774 0082', 'type': ListerType.agent},
    {
      'id': 'ag_10',
      'name': 'Agent Haruna', 
  ...
  properties.addAll([
    Property(
      ...
      listerLogoUrl: 'https://api.dicebear.com/7.x/initials/png?seed=SKY&backgroundColor=0f766e',
      ...
      panoramaUrl:
          'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=2000&q=80',
      isTest: true,
      coOfOUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
      governorsConsentUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
      surveyPlanUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
      deedOfAssignmentUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
      buildingPlanApprovalUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
      soilTestReportUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
      structuralIntegrityReportUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    ),
    Property(
      id: 'hero_2',
      ...
      listerType: ListerType.realEstateCompany,
      listerLogoUrl: 'https://api.dicebear.com/7.x/initials/png?seed=PE&backgroundColor=8b5cf6',
    ...
    Property(
      ...
      listerId: 'ag_2',
      listerName: 'Bode Thomas Properties',
      listerType: ListerType.realEstateCompany,
      listerLogoUrl: 'https://api.dicebear.com/7.x/initials/png?seed=BT&backgroundColor=1e293b',
