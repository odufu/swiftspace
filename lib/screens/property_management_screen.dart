...
import 'rental_agreement_screen.dart';
        ...
        action = () {
          showDialog(
            ...
            builder: (ctx) => AlertDialog(
              ...
              content: const Text('Would you recommend this agent and confirm the inspection went well?'),
              actions: [
                TextButton(
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    Provider.of<BookingProvider>(context, listen: false)
                        .rateAgent(booking.id, 5, 'Inspection Completed Successfully.');
                    AudioManager().playSuccess(context);
                    setState(() {});
                    ...
                    Future.delayed(const Duration(milliseconds: 300), () {
                      ...
                      showDialog(
                        context: context,
                        builder: (negCtx) => AlertDialog(
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                          title: const Row(children: [Icon(LucideIcons.checkCircle, color: Colors.green), SizedBox(width: 8), Text('All Done!')]),
                          content: const Text('The inspection is complete. Would you like to make an offer and start negotiating with the agent now?'),
                          actions: [
                            TextButton(
                              onPressed: () => Navigator.pop(negCtx),
                              child: const Text('Maybe Later', style: TextStyle(color: Colors.grey)),
                            ),
                            ElevatedButton(
                              onPressed: () {
                                Navigator.pop(negCtx);
                  ...
                  child: const Text('Approve & Proceed'),
                )
              ],
            ),
          );
