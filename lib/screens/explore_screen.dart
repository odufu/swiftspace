...
import '../widgets/property_snippet.dart';
import '../screens/property_details_screen.dart';
import '../screens/advanced_explore_screen.dart';
import 'package:lucide_icons/lucide_icons.dart';
import 'package:audioplayers/audioplayers.dart';
import 'dart:ui';
import '../providers/user_preferences_provider.dart';
import '../services/ai_recommendation_service.dart';
import '../widgets/best_offer_card.dart';
...
class _ExploreScreenState extends State<ExploreScreen>
  ...
  final List<String> _userPriorities = ['price', 'road', 'utilities', 'hospital'];
  ...
  Widget _buildPriorityChip(String label, String id, ThemeData theme, StateSetter setModalState) {
  ...
  List<Property> get _filteredProperties {
    ...
    if (_sortByBestOffer) {
      ...
      final result = AiRecommendationService.rankProperties(
        ...
        priorities: _userPriorities.isNotEmpty ? _userPriorities : ['price', 'road', 'utilities', 'hospital'],
      );
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          final isSelected = _selectedTerms.contains('buy');
                          return FilterChip(
                            avatar: Icon(
                              LucideIcons.home,
                              size: 14,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Slider(
                            ...
                            label: '${_bestOfferRadius.toStringAsFixed(0)} km',
                            onChanged: (val) {
                              setModalState(() => _bestOfferRadius = val);
                              setState(() {});
                            },
                          ),
                          const Padding(
                          ...
                          Wrap(
                            ...
                            runSpacing: 8,
                            children: [
                              _buildPriorityChip('💰 Price', 'price', theme, setModalState),
                              _buildPriorityChip('🛣️ Road Access', 'road', theme, setModalState),
                              _buildPriorityChip('⚡ Utilities', 'utilities', theme, setModalState),
                              _buildPriorityChip('🏥 Healthcare', 'hospital', theme, setModalState),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Text(
                    ...
                    child: ReorderableListView(
                      ...
                      children: currentPriorities.map((priority) {
                        ...
                        return ListTile(
                          ...
                          leading: Icon(icon, color: Colors.purple, size: 20),
                          title: Text(
                            label,
                      ...
                      onReorder: (oldIndex, newIndex) {
                        ...
                        final List<String> items = List.from(currentPriorities);
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  hintText: 'Search location, type, or developer...',
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                themeProvider.toggleTheme(
                  !isDark,
                ); // Toggles from explicit current rendered mode
              },
              child: Icon(
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              ...
              child: AnimatedBuilder(
                ...
                builder: (context, _) {
                  final isExpanded = _sheetController.isAttached && _sheetController.size > 0.5;
                  return Icon(
        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: _buildGridView(theme, scrollController),
              ),
            ],
          ),
        );
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const AdvancedExploreScreen()),
                );
              },
            ),
          ),
        ...
        itemBuilder: (context, index) {
          ...
          if (isBestOfferIdx) {
            return BestOfferCard(
              property: prop,
              reasoning:
                  _aiReasonings[prop.id] ?? "Top match for your interests.",
              onTap: () {
                Navigator.push(
                  context,
                  PageRouteBuilder(
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        const Color(0xFF1EB476).withValues(alpha: opacity),
                        Colors.transparent,
                      ],
                    ),
                  ),
              ...
              builder: (ctx, _) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        const Color(0xFF0F5A3F).withValues(alpha: opacity),
                        Colors.transparent,
                      ],
                    ),
                  ),
                            ...
                            Expanded(
                              child: Focus(
                                ...
                                child: TextField(
                                  ...
                                  cursorColor: const Color(0xFF1EB476),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              colors: [
                                const Color(0xFF1EB476).withValues(alpha: 0.12),
                                const Color(0xFF0F5A3F).withValues(alpha: 0.08),
                              ],
                            ),
                          ),
                          child: Row(
